...
function Mascot({ variant = "default", size = 96 }) {
  const map = {
...
function Avatar({ name, color = "sky", size = 36 }) {
  const palette = {
...
function Badge({ children, color = "sky", dot }) {
  const palette = {
...
Object.assign(window, { Mascot, Logo, Avatar, Button, Badge });
