...
import { Button, Mascot } from "./Primitives.jsx";
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        {stage === "done" ? (
          <div style={{ textAlign: "center", padding: "16px 0 8px" }}>
            <div style={{ animation: "pkbounce 700ms cubic-bezier(.34,1.56,.64,1)", display: "inline-block" }}>
            ...
            {stage === "idle" && (
              <>
                <div
                  ...
                  onDrop={(e) => {
                    e.preventDefault(); setDragActive(false); dragCount.current = 0;
